VERSION 5.00
Begin VB.Form frmTakeVOLTinsleyTemperatures 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Tinsley VOL Temperature Measurement"
   ClientHeight    =   8115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8865
   ...
   End
End
Attribute VB_Name = "frmTakeVOLTinsleyTemperatures"
...
For ProbeCounter = 2 To 13
    xlsheetResultsTemperature.Cells(ProbeCounter, 2) = ""
    'Clears Excel spreadsheet by placing 0's in all boxes
    xlsheetResultsTemperatureUncorrected.Cells(ProbeCounter, 2) = ""
Next ProbeCounter
cmdResultsNotOk.Visible = False
cmdResultsOk.Visible = False
lblTemperatureOk.Visible = False
'hides the two buttons and the label
End Sub

Private Sub cmdResultsOk_Click()
Rownumber = 3
'Changes rownumber to 3 to signify that the next temperature results
'are for Initial material temperatures
Unload Me
'unload form
End Sub
