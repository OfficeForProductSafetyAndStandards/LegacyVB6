...
Set xlbook = xl.Workbooks.Open("k:\@Private\@Mu\Edale Correction.xls", , , , , , True)
...
Err.Clear                   'Clear Err object in case error occurred.
On Error GoTo 0             'Resume normal error processing
Set xlbookResults = xl.Workbooks.Open("k:\@Private\@Mu\Length Bench Results Rigid.xls", , , , , , True)
