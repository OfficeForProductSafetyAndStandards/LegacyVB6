...
Begin VB.Form frmMeasurementSelection 
   ...
   Begin VB.CommandButton cmdAgilent1339 
      Caption         =   "Agilent 1339"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub cmdAgilent1339_Click()
    optClassI.Enabled = True
    optClassII.Enabled = True
    optClassIII.Enabled = True
    xlsheetResultsMeasurement.Cells(27, 2) = "Agilent 1339"
End Sub
...
xlbookResults.Save
'===========================================================
'   Agilent update SBB 8/3/2010
'Call setuplaser(BenchUsed, Units) 'call setuplaser module  'Removed SBB
Call SetLaserParameter(10, dbScaleFactor)   'Scale factor for laser
...
xlsheetResultsMeasurement.Cells(27, 2) = "Agilent 1339" '"IB4073" changed Agilent SBB 8/3/2010
