...
Begin VB.Form frmManualEdaleEntry 
   ...
   Begin VB.Label lblwait 
      Appearance      =   0  'Flat
      BackColor       =   &H00C0FFC0&
      Caption         =   $"frmRigidManualEdaleEntry.frx":0000
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
...
'Dim rsLengthResults As ADODB.Recordset
'Dim x As Integer
'Dim y As Integer
...
'rsLengthResults.Fields("DayBookNo") = xlbookResults.Sheets("VOL and Customer Data").Cells(2, 2)
'rsLengthResults.Update
'rsLengthResults.Close
