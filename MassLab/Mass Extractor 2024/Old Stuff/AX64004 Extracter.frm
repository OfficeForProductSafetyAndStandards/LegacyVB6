...
Begin VB.Form frmMassExtract 
   ...
   Begin VB.ComboBox cboClass 
      Height          =   315
      Index           =   4
      ItemData        =   "frmMassExtracter.frx":0000
      Left            =   8280
      List            =   "frmMassExtracter.frx":000A
      TabIndex        =   31
      Text            =   "Combo1"
      Top             =   3480
      Width           =   1575
   ...
   Begin VB.ComboBox cboClass 
      Height          =   315
      Index           =   3
      ItemData        =   "frmMassExtracter.frx":0016
      Left            =   6600
      List            =   "frmMassExtracter.frx":0020
      TabIndex        =   30
      Text            =   "Combo1"
      Top             =   3480
      Width           =   1575
   ...
   Begin VB.ComboBox cboClass 
      Height          =   315
      Index           =   2
      ItemData        =   "frmMassExtracter.frx":002C
      Left            =   4920
      List            =   "frmMassExtracter.frx":0036
      TabIndex        =   29
      Text            =   "Combo1"
      Top             =   3480
      Width           =   1575
   ...
   Begin VB.ComboBox cboClass 
      Height          =   315
      Index           =   1
      ItemData        =   "frmMassExtracter.frx":0042
      Left            =   3240
      List            =   "frmMassExtracter.frx":004C
      TabIndex        =   28
      Text            =   "Combo1"
      Top             =   3480
      Width           =   1575
   ...
   Begin VB.ComboBox cboClass 
      Height          =   315
      Index           =   0
      ItemData        =   "frmMassExtracter.frx":0058
      Left            =   1560
      List            =   "frmMassExtracter.frx":0062
      TabIndex        =   27
      Text            =   "Combo1"
      Top             =   3480
      Width           =   1575
   ...
   Begin VB.ComboBox cboMetrologist 
      Height          =   315
      ItemData        =   "frmMassExtracter.frx":006E
      Left            =   1560
      List            =   "frmMassExtracter.frx":0084
      TabIndex        =   22
      Top             =   3960
      Width           =   1575
   End
   ...
   Begin VB.TextBox txtCustomerNo 
      ...
      TabIndex        =   20
      Text            =   "frmMassExtracter.frx":00CF
      Top             =   1080
      Width           =   1575
   End
   Begin VB.TextBox txtCustomerNo 
      ...
      ScrollBars      =   2  'Vertical
      TabIndex        =   19
      Text            =   "frmMassExtracter.frx":00D5
      Top             =   1080
      Width           =   1575
   End
   ...
   Begin VB.TextBox txtCustomerNo 
      ...
      ScrollBars      =   2  'Vertical
      TabIndex        =   13
      Text            =   "frmMassExtracter.frx":00DB
      Top             =   1080
      Width           =   1575
   End
   Begin VB.TextBox txtCustomerNo 
      ...
      ScrollBars      =   2  'Vertical
      TabIndex        =   12
      Text            =   "frmMassExtracter.frx":00E1
      Top             =   1080
      Width           =   1575
   End
   Begin VB.TextBox txtCustomerNo 
      ...
      ScrollBars      =   2  'Vertical
      TabIndex        =   11
      Text            =   "frmMassExtracter.frx":00E7
      Top             =   1080
      Width           =   1575
   End
   Begin VB.TextBox txtDeptNo 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   $"frmMassExtracter.frx":00ED
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Else
    ...
    For x = Position1 To Position2
        If Left(xlSheetResults.Cells(x, 3), 2) = "IB" Then
        Me.Visible = True
