...
namespace WinFormsApp1
{
...

    {
        ...
        static void SetUp()
        {
            ...
            */
            /*
            ProcessStartInfo startInfoEdale = new ProcessStartInfo();
            startInfoEdale.FileName = "C:\\Program Files\\Microsoft Office\\root\\Office16\\EXCEL.EXE";
            startInfoEdale.Arguments = filename;
            Process.Start(startInfoEdale);
            Microsoft.Office.Interop.Excel.Application excelAppEdale = new Microsoft.Office.Interop.Excel.Application();

            
            ProcessStartInfo startInfoLength = new ProcessStartInfo();
            filename = "\"" + edalePath + "Length Bench Results Flexi.xlsx" + "\"";
            startInfoLength.FileName = "C:\\Program Files\\Microsoft Office\\root\\Office16\\EXCEL.EXE";
            startInfoLength.Arguments = filename;
            Process.Start(startInfoLength);
            ...
            filename = edalePath + "Length.xlsx";
